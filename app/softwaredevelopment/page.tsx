...
import flutterimg from "../../public/images/softwaredevelopment/flutter.png"
import reactnativeimg from "./../../public/images/softwaredevelopment/react-native.png"
      ...
      <div className='flex flex-col w-full  max-sm:overflow-x-hidden'>
        {data.map((single, index) => (
          <MobileApp 
            ...
            paragraph2={single.paragraph2} color={undefined}          />
        ))}
        {
