...
import flutterimg from "../../public/images/mobileappdevelopment/flutter.png"
import reactnativeimg from "./../../public/images/mobileappdevelopment/react-native.png"
...
const Page = () => {
  return (
    <>
      <div className='flex flex-col w-full  max-sm:overflow-x-hidden'>
        ...
        <HighlightFeatures heading={undefined} paragraph={undefined}/>
